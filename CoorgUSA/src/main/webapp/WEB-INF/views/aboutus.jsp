...
<title>Coorg-USA:About Us</title>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<article>
					...
					<div class="row">
						<div class="col-md-12">
							<p>Started in July 2016, CoorgUSA.com is a portal started to share news, blogs, posts related to Coorgs happening in USA.<br /> The website is owned and operated by <b>Kushalappa
									Ponnimada</b> &amp; <b>Pooja Ponnamma</b>.
							</p> <br />
							<div class="row">
								<div class="col-md-6">
									<div class="thumbnail">
										...
										<div class="caption text-center">
											<h4>Kushalappa Ponnimada</h4>
											<a role="button" class="btn btn-sm btn-success">View Profile</a>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="thumbnail">
										<img src="" class="img-responsive" />
										<div class="caption text-center">
											<h4>Pooja Ponnamma</h4>
											<a role="button" href="#" class="btn btn-sm btn-success">View Profile</a>
										</div>
									</div>
								</div>
							</div>
